...
const Hero = () => {
  ...
  return (
    <div className="text-center relative z-10 max-w-4xl px-4">
      ...
      >
        Software Engineer | Actively seeking full-time opportunities starting
        immediately
      </motion.p>
      ...
      >
        ...
        <div className="flex gap-4 justify-center">
          {callToActionButtons.map(({ label, bgColor, hoverColor, onClick }) => (
            <motion.button
              key={label}
              className={`mt-8 px-6 py-3 ${bgColor} text-white font-semibold rounded-md ${hoverColor} transition-all duration-300 shadow-lg hover:shadow-xl`}
